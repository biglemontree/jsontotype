...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Congratulations, your extension "somatotype" is now active!');
  ...
  context.subscriptions.push(vscode.commands.registerCommand('jsontotype.totype', (textEditor, edit) => {
    ...
    selectRange.forEach((range) => {
			...
			if (text) {
				...
				vscode.window.showErrorMessage('未选中任何文字！');
			}
		});
  }));
}
